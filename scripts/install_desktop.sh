...
# Installiere Desktop-Abhängigkeiten
log "Installiere Desktop-Abhängigkeiten..."
...
if [ $? -eq 0 ]; then
    log "Desktop-Installation erfolgreich abgeschlossen!"
    log "Sie können VRMusic Studio jetzt über das Desktop-Icon oder mit './scripts/start.sh --desktop' starten."
else
