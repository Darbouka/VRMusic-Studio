...
public:
    ...
    // Konfiguration
    void setConfig(const VRRoomConfig& config);
    VRRoomConfig getConfig() const;
    ...
    // Interaktionsmodus
    void setInteractionMode(VRRoomConfig::InteractionMode mode);
    VRRoomConfig::InteractionMode getInteractionMode() const;
